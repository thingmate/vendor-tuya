...
import { IOnOffState, onOffStateFromBoolean, onOffStateToBoolean, ThingProperty } from '@thingmate/wot-scripting-api';
...
export class TuyaOnOffStateThingProperty extends ThingProperty<IOnOffState> {
  constructor(
    {
      context,
      deviceId,
