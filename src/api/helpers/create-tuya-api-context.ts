...
import { getTuyaAccessToken } from '../apis/token/get/get-tuya-access-token';
import { refreshTuyaAccessToken } from '../apis/token/refresh/refresh-tuya-access-token';
import { ITuyaAccessToken } from '../apis/token/types/tuya-access-token/tuya-access-token.type';
import { IBaseTuyaApiRequestOptions } from './fetch-tuya-api';
...
export interface ICreateTuyaApiContextOptions extends Omit<IBaseTuyaApiRequestOptions, 'abortable' | 'accessToken' | 'body'> {
